...
Drag either side edge of the input to resize the input and chat messages together.
Both stay centered; the shared preferred width is remembered across reloads. Double-click an edge to restore
normal width. Keyboard: focus an edge, use Left/Right to resize, Home to reset.

The composer and transcript share a width preference. The unsent draft is untouched.
...
application. They exercise drag geometry, synchronized transcript/input widths and draft preservation, persistence,
